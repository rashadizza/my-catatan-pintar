...
<body>
    ...
    <div class="sidebar flex-item min-h-screen w-[3.35rem] overflow-hidden border-r hover:text-[#ffffff] hover:shadow-lg"
        ...
        <div class="lg:w-2/4 mx-auto py-8 px-6 bg-white rounded-xl">
            ...
            <div class="mb-6">
                <form class="flex flex-col space-4" method="POST" action="/">
                    @csrf
                    <input type="text" name="title" placeholder="To Do List Title" class="py-3 px-4 bg-gray-100 rounded-xl">
                    <textarea name="description" placeholder="To Do List Description" class="mt-4 py-3 px-4 bg-gray-100 rounded-xl"></textarea>
                    <div class="mt-4"></div>
