...
<body>
    <div
        class="flex-container min-h-screen bg-gradient-to-b from-white from-2% via-[#66fcfb] via-26% to-[#1a1b77] to-82%">
        <!--====== SIDE PART START ======-->
        ...
        <!--====== CONTENT PART START ======-->
        <div style="flex:4" class="note shadow-md flex-item py-3 px-4">
            <br><br><br>
            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-white uppercase bg-[#1a1b77] dark:bg-gray-700 dark:text-gray-400">
                        <tr>
            ...
            <br>
            <div class="col-md-12">
                <a type="button" href="{{ route('notes.add') }}"
                    class="faust button text-white bg-[#1a1b77] hover:bg-[#fd53b8] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
